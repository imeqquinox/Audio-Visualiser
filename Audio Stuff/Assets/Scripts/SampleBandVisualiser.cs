...
public class SampleBandVisualiser : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        for (int i = 0; i < 64; i++)
        {
            ...
            sampleInstance.transform.position = lastCubePosition + (Vector3.right * 2);
            lastCubePosition = sampleInstance.transform.position;
